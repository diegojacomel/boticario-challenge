...
function Button({ children, type, fontColor, fontHoverColor, backgroundColor, backgroundHoverColor, underlineOnHover, outline, size, fontSize, rounded, block, disabled, onClick, innerRef }) {
    return (
        <ButtonStyle
            type={type}
